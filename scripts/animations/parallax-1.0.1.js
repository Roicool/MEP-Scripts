/**
 * Parallax 1.0.1 — section'a tek attribute, layout bozmayan scroll efekti.
 ...
 *
 * 1.0.1: gsap.registerPlugin(ScrollTrigger) idempotent çağrısı.
 *        Mesafe artık function-based — resize/refresh'te doğru değer kullanılıyor
 *        (önceden init anında cache'lenip yanlış kalıyordu). Init sonrası refresh.
 */
(function () {
  'use strict';
  ...
  function init() {
    ...
    sections.forEach(function (section) {
      ...
      if (target) {
         ...
         * Mesafe function — refresh'te yeni vh ile yeniden hesaplanır.
         */
        gsap.fromTo(target,
