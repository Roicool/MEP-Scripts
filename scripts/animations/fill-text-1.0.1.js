/**
 * FillText 1.0.1 — SplitText scroll fill animasyonu (.fill-text) (homepage footer).
 *
 * 1.0.1: invalidateOnRefresh: true eklendi — başka scriptlerin refresh'lerinde
 *        line trigger pozisyonları doğru güncellensin. Init sonrası refresh.
 */
(function () {
  function run() {
